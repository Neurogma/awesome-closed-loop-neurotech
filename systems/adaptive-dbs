...
**Reproducible:** the software stack (Dareplane + py_neuromodulation) against a benchtop rig or simulated data. This can be set up without clinical access.
